...
###########
resource "azurerm_private_endpoint" "priv_ep_was" {
    name                = "${var.azure_name_prefix}_private_endpoint_was"
    location            = azurerm_resource_group.rg.location
    resource_group_name = azurerm_resource_group.rg.name
    subnet_id           = azurerm_subnet.was_subnet.id

    private_service_connection {
        name                           = "priv_conn_for_service_account_was"
...
resource "azurerm_private_endpoint_application_security_group_association" "priv_ep_asc_was" {
  private_endpoint_id           = azurerm_private_endpoint.priv_ep_was.id
